    ...
    public class TransitionProfileEditor : Editor {
        ...
        void OnEnable() {
            ...
            try {
                ...
                pixelization = serializedObject.FindProperty("pixelization");
        ...
        public override void OnInspectorGUI() {
            ...
            if (transitionType.SupportsPixelization()) {
                EditorGUILayout.PropertyField(pixelization);
            }
